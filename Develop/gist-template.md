...
This is a presentation of suitable expression sequence for specifying regex. It helps developer in the apprehension  of regex search process and charater significance. 

## Summary

Regex is a collection of charater and symbols that describes the sequence of desired search pattern. Here, regex expressions are examplified to serve as s guide for developers in designing a suitable search and find algoriths.
